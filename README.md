![alt text](http://txemacoin.uk.to/txm_logo.png "Logo")
...
If it is a simple/trivial/non-controversial change, then one of the Txemacoin
...
regularly to indicate new official, stable release versions of Txemacoin.
