...
uint256 hashGenesisBlock("0x035a480072d1b61afbcabc46657bf3cc7ea147341156b3db8b6b63ae6f6326ef");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Txemacoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Txemacoin Signed Message:\n";
...
{
    // Txemacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Txemacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Txemacoin: 3.5 days
static const int64 nTargetSpacing = 150; // Txemacoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Txemacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Txemacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Txemacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa0145a4ef915d79f95da3ecc416cc6f53f3c72902977cf5eb3aa5998cbeabcc6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Txemacoins for everyone!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("2ff0735799d7037385662f38464cf79b4f5e4c6796aaf93b4dbe9a778522548c4e83adda48e129e1313df5aecda7598b4ad56066427374bc9d40a7e676d23e76cc") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513354550;
        block.nBits    = 504365644;
        block.nNonce   = 1471433430;

        if (fTestNet)
        {
            block.nTime    = 1513354550;
            block.nNonce   = 1229755512;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6e831221406b28a931c2038b7c18640e05573c3fbaf6d2d7c94ca0dfbc2d921a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Txemacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TxemacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TxemacoinMiner : ProcessBlock, block not accepted");
    }
